                ...
                <form onSubmit={handleLogin} className="glass-morphism p-10 space-y-8 rounded-none border-t-4 border-t-primary">
                    <div className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <input type="password" value={username} onChange={(e) => setUsername(e.target.value)} className="input-field text-lg font-bold placeholder:text-white/5" placeholder="IDENTIFIER" />
                        </div>
                        <div className="space-y-2">
